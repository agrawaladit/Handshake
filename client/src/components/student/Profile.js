      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xl-9">
            <ProfileField t1="Bachelors Education" g1="Masters Education" t2="Demo" todo={this.handleEducation} eduComp={true} t2={ed.school} id={this.props.profile.id} f1={ed.degree} f2={ed.location} f3={ed.major} f4={ed.cgpa} f5={ed.start_date} f6={ed.end_date} />
